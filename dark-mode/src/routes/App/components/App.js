...
function App() {
  ...
  useEffect(() => {
    ...
    return isDarkMode ? classList.add(darkModeClass) : classList.remove(darkModeClass);
  }, [isDarkMode]);
  ...
  return (
    <div className="app">
      <div className="level">
        ...
        <button onClick={() => setDarkMode(!isDarkMode)} className="app__dark-mode-btn icon level-right">
          <FontAwesomeIcon icon={isDarkMode ? faSun : faMoon} color={isDarkMode ? '#FFA500': null} />
        </button>
